...
#---------------------------------------
# new bagpipes fits, as on 11/3 - effect seems to be to slightly lower dust and raise SFRs
#---------------------------------------
...
#bagpipes_cat_z1 = np.genfromtxt('code_outputs/bagpipes_11_3_19_z1_noir.dat')
